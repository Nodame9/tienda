...
<div class="container">
  ...
  <h1><strong>Lista de Categor&iacute;as</strong></h1>
  <p><a href="categorias_add.php">A&ntilde;adir Categor&iacute;a</a></p>
  <table width="100%" border="0" cellspacing="2" cellpadding="15">
    <tr>
      <td bgcolor="#FFFFCC">Nombre de Categoria</td>
      <td bgcolor="#FFFFCC">Acciones</td>
    </tr>
    <?php do { ?>
      <tr class= "brillo">
        <td><?php echo $row_Recordset1['Descripcion']; ?></td>
        <td><a href="categorias_edit.php?recordID=<?php echo $row_Recordset1['idCategoria']; ?>">Editar</a>
        <a href="categoria_delete.php?recordID=<?php echo $row_Recordset1['idCategoria']; ?>">-Eliminar</a></td>
      </tr>
