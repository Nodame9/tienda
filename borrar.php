...
$query_ConsultaFuncion = sprintf("SELECT usuario.Nombre FROM usuario WHERE usuario.idUsuario=%s", GetSQLValueString($varUsuario_ConsultaFuncion, "int"));
...
<body>
<?php echo $row_ConsultaFuncion['Nombre']; ?>
</body>
</html>
<?php
